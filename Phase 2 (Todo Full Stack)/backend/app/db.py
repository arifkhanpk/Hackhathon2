...
# If it's a PostgreSQL URL, convert to asyncpg driver
if database_url.startswith("postgresql://"):
    ...
    # For SQLite and other databases, no special handling needed
    connect_args = {}
...
engine = create_async_engine(
    ...
    pool_size=10,        # Set pool size (ignored for SQLite)
    max_overflow=20      # Allow overflow (ignored for SQLite)
)
